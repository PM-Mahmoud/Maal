...
const ROADMAP: RoadmapItem[] = [
  ...
  { title: "Personalised Financial Insights", body: "Educational insights tailored to your situation. Maal analyzes your portfolio patterns and surfaces things worth understanding — like how rebalancing, debt payoff order, or budget allocation changes could affect your score. Educational only; the decisions stay yours.", votes: 351, category: "Ask Maal" },
  ...
  { title: "Maal Action Commands", body: "Enhance Maal's capabilities to perform direct actions through chat commands. Ask Maal to add new assets, categorize transactions, upload documents, generate reports, or create budgets - all through natural conversation.", votes: 138, category: "Ask Maal" },
  ...
  { title: "My Prompts", body: "Save your favorite prompts for quick access. This feature lets you organize your most useful prompts for future use with Maal.", votes: 120, category: "Ask Maal" },
