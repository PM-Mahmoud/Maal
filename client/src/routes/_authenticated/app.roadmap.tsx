...
const CHANGELOG: ChangelogItem[] = [
  ...
  { kind: "feature", title: "CSV Uploads in Chat", body: "You can now upload CSV files directly to Maal and ask her to analyse them. Useful for transaction exports, custom holdings lists, or any tabular data you want her to reason over.", date: "May 12, 2026", votes: 44 },
...
const ROADMAP: RoadmapItem[] = [
  ...
  { title: "Values Lens — Halal & Ethical Investing", body: "An opt-in values filter on top of your neutral Maal core. Turn it on and your portfolio views, screens and educational suggestions are filtered through a halal or ethical lens — with ways to improve your financial wellbeing that don't rely on loans and credit. Its own page in the side menu; off by default, and the rest of Maal stays exactly as it is.", votes: 0, category: "Insights" },
  { title: "Credit Score Integration", body: "Optionally add your credit score (from Equifax, Experian or illion) as one more input to your financial picture. Maal is not a credit score — and never will be — but if you have one, Maal can factor it in alongside your savings, debt, super, trajectory and protection pillars.", votes: 0, category: "Insights" },
  { title: "Anonymous Peer Benchmarking", body: "Compare your financial performance to anonymised data from similar Maal users. See how your spending, saving, and investing habits stack up against others in your income bracket, age group, or location without compromising anyone's privacy.", votes: 375, category: "Insights" },
  { title: "Personalised Financial Insights", body: "Educational insights tailored to your situation. Maal analyses your portfolio patterns and surfaces things worth understanding — like how rebalancing, debt payoff order, or budget allocation changes could affect your score. Educational only; the decisions stay yours.", votes: 351, category: "Ask Maal" },
  ...
  { title: "Maal Action Commands", body: "Enhance Maal's capabilities to perform direct actions through chat commands. Ask Maal to add new assets, categorise transactions, upload documents, generate reports, or create budgets - all through natural conversation.", votes: 138, category: "Ask Maal" },
  ...
  { title: "My Prompts", body: "Save your favourite prompts for quick access. This feature lets you organise your most useful prompts for future use with Maal.", votes: 120, category: "Ask Maal" },
