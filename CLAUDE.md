...
- **Design language (2026-06-14, matches sibling promptdoc)**: font **Geist** (300–700; headings semibold 600, tight tracking). Warm palette — cream bg #FAF8F4, white surface, #F2EEE6 surface-2, ink #1A2421; **deep-teal primary/accent #0F5D5E** (soft #E2EDEA), **terracotta secondary --gold #C45F37** (soft #FBE9DF), line #E4DDD0. Dark = #0E1413 bg, teal #58B3A4, terracotta #EF9B72. Soft shadows (`--shadow` present), 12px radius, pill buttons, soft-shadowed cards that lift on hover (`.stat-card:hover translateY`), normal-case semibold `.panel-title`, teal focus ring. Both stylesheets: tokens at top + "PromptDoc pass" override layer at bottom — put new visual overrides there
