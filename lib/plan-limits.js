...
// 'YYYY-MM' period key — usage resets on the 1st of each month.
...
function upgradeMessage(plan, feature) {
  ...
  return 'You’ve used all your ' + name + ' for this month on the ' + (p === 'pro' ? 'Pro' : 'Max') + ' plan. Your usage resets on the 1st.' + (p === 'pro' ? ' Upgrade to Max in Plan & Usage for higher limits.' : '');
}
